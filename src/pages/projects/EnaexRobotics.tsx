      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Autonomous and telecomanded robotic systems in underground and open-pit environments
          </p>
        </div>
